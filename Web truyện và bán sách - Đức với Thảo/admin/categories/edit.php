...
<?php 
    $idTL = $_GET['id'];
    $str_id = "SELECT * FROM theloai WHERE id = $idTL";
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="mainleft">
            <div class="header">
                <div class="tittle">Chỉnh sửa thể loại</div>
                <div class="infoadmin">
                    <div class="img">
                        <?php 
                            if (isset($_SESSION['id'])) {
            ...
            <form action="xuly-edit.php" method="get">
                <div><label for="">Tên thể loại:</label></div>
                <input type="text" value="<?php echo $row['tittle']; ?>" name="ten" id="">
                <br> <br> <br>
                <div><label for="">Mô tả:</label></div>
                <textarea type="textarea" name="mota" id=""><?php echo $row['description']; ?></textarea>
                <br> <br> <br>
                ...
                <br> <br> <br>
                <input type="hidden" name="id" value="<?php echo $idTL; ?>">
