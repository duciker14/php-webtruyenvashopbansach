...
<?php 
    $idUpdate = $_GET['id'];
    $str_id = "SELECT * FROM cart WHERE id = $idUpdate";
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="mainleft">
            <div class="header">
                <div class="tittle">Chỉnh sửa thông tin sản phẩm</div>
                <div class="infoadmin">
                    <div class="img">
                        <?php 
                            if (isset($_SESSION['id'])) {
            ...
            <form action="xuly-edit.php" method="get">
                ...
                <input type="text" value="<?php echo $row['name']; ?>" name="tenEdit" id="">
                <br> <br> <br>
                <div><label for="">GIÁ:</label></div>
                <input type="text" value="<?php echo $row['price']; ?>" name="giaEdit" id="">
                <br> <br> <br>
                <div><label for="">HÌNH ẢNH:</label></div>
                <input type="text" value="<?php echo $row['thumbnail1']; ?>" name="anhEdit" id="">
                <br> <br> <br>
                <div><label for="">GIỚI THIỆU</label></div>
                <textarea type="textarea"  name="gioithieuEdit" id=""><?php echo $row['content1']; ?></textarea>
                <br> <br> <br>
                <div><label for="">TÁC GIẢ</label></div>
                <input type="text" value="<?php echo $row['tacgia']; ?>" name="tacgiaEdit" id="">
                <br> <br> <br>
