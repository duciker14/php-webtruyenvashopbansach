...
<?php 
    ...
    $str_id = "SELECT * FROM code WHERE id = $idUpdate";
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="mainleft">
            <div class="header">
                <div class="tittle">Chỉnh sửa mã giảm giá</div>
                <div class="infoadmin">
                    <div class="img">
                        <?php 
                            if (isset($_SESSION['id'])) {
            ...
            <form action="xuly-edit.php" method="get">
                ...
                <input type="text" value="<?php echo $row['code']; ?>" name="codeUd" id="">
                <br> <br> <br>
                <div><label for="">Tên Code:</label></div>
                <textarea type="textarea" name="nameUd" id=""><?php echo $row['name']; ?></textarea>
                <br> <br> <br>
                <div><label for="">Giá trị giảm:</label></div>
                <input type="text" value="<?php echo $row['value']; ?>%" name="valueUd" id="">
                <br> <br> <br>
                <input type="hidden"  value="<?php echo $idUpdate ?>" name="idUpdate" >
