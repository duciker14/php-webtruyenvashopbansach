...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="mainleft">
            <div class="header">
                <div class="tittle">Thêm mới bài viết</div>
                <div class="infoadmin">
                    <div class="img">
                        <?php 
                            if (isset($_SESSION['id'])) {
            ...
            <form action="action.php" method="get">
                ...
                <textarea type="textarea" name="trichdan" id=""></textarea>
                <br> <br> <br>
                <div><label for="">Đoạn 1:</label></div>
                <textarea type="textarea" name="doan1" id=""></textarea>
                <br> <br> <br>
                <div><label for="">Đoạn 2:</label></div>
                <textarea type="textarea" name="doan2" id=""></textarea>
                <br> <br> <br>
                <div><label for="">Đoạn 3:</label></div>
                <textarea type="textarea" name="doan3" id=""></textarea>
                <br> <br> <br>
                <div><label for="">Tên ảnh 1:</label></div>
                <input type="text" name="anh1" id="">
                <br> <br> <br>
                <div><label for="">Tên ảnh 2:</label></div>
                <input type="text" name="anh2" id="">
                <br> <br> <br>
                <div><label for="">Ngày tạo:</label></div>
                <input type="date" name="ngaytao" id="">
                <br> <br> <br>
                <div><label for="">Ngày cập nhật:</label></div>
                <input type="date" name="ngaycapnhat" id="">
                <br> <br> <br>
